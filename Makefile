...
EXEC=client-tutoriel client-interactif client-tutorielFORT client-projetX client-crypteMove client-crypteMove2 client-BayOfPigs client-BayOfPigs2
...
client-BayOfPigs2: client-BayOfPigs2.o client.o
clean:
	rm -f *.o
